...
namespace MovieApp.Infrastructure.Migrations
{
    ...
    [Migration("20241015094751_AddUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0a43c618-1209-4717-a410-c0b1f8ebb381",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "5902ff8c-7929-4cac-86be-dd0604be3904",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("aspdotnet_project.App.Cinema.Entities.SeatType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("aspdotnet_project.App.Cinema.Entities.Seat", b =>
                {
                    ...
                    b.HasOne("aspdotnet_project.App.Cinema.Entities.SeatType", "Type")
                        .WithMany("Seats")
